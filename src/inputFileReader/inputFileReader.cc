...
void inputFileReader::declare_parameters(dealii::ParameterHandler & parameter_handler,
    ...
    parameter_handler.declare_entry("Minimum allowed distance between nuclei","",dealii::Patterns::Double(),"The minimum allowed distance between nuclei placed during the same time step.");
