...
{
  this->compute_subset_attributes(fieldSolveType::EXPLICIT_NUCLEATION);
...
explicitNucleationSolver<dim, degree>::solve()
{
  ...
  this->system_matrix->compute_nucleation_explicit_update(new_solution_subset,
                                                          solution_subset);
  ...
  this->solution_handler->update(fieldSolveType::EXPLICIT_NUCLEATION);
}
