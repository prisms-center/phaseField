                                              ...
                                              variableAttributeLoader variable_attributes)
{
  ...
  min_distance_between_OP =
    parameter_handler.get_double("Minimum allowed distance between nuclei OP");
  multiple_nuclei_per_order_parameter =
    parameter_handler.get_bool("Allow multiple nuclei per order parameter");
