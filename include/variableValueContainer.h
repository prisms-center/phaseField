...
public:
    ...
    double operator()(unsigned int global_variable_index)
    {
        ...
        // If this point is reached, the index isn't allowed so an error should be thrown
...
// void variableValueContainer::set(unsigned int global_variable_index, double variable_value){
//     var_index.push_back(global_variable_index);
//     value.push_back(variable_value);
//     num_entries++;
// }
//
// double variableValueContainer::operator()(unsigned int global_variable_index){
//     for (unsigned int i=0; i < num_entries; i++){
//         if (global_variable_index == var_index[i]){
//             return value[i];
//         }
