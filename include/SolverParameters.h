...
enum SolverToleranceType { ABSOLUTE_RESIDUAL,
    RELATIVE_RESIDUAL_CHANGE,
    ABSOLUTE_SOLUTION_CHANGE };

/**
 * This is a base class that holds parameters related to a numerical solver (either linear or nonlinear)
 * As in many other PRISMS-PF classes,
 * access to the parameters for the separate governing equations is specified via the global variable
 * index. Requests for solver parameters for inappropriate governing equations return errors.
 */
...
/**
 * This class holds all of the parameters for the linear solver. Requests for linear
 * solver parameters for governing equations without a matrix inversion return errors.
 */
class LinearSolverParameters : public SolverParametersBase {
public:
    /**
     * Method to load the parameters for one governing equation into the class. This must be
     * defined for all classes derived from SolverParametersBase.
     */
...
/**
 * This class holds all of the parameters for the nonlinear solver. Requests for nonlinear
 * solver parameters for non-nonlinear governing equations return errors.
 */
