...
set(VTK_DIR "" CACHE PATH "An optional hint to a VTK directory")
...
if(NOT DEAL_II_WITH_VTK AND PRISMS_PF_WITH_VTK)
  message(STATUS "deal.II wasn't built with VTK, checking for separate installation...")
  find_package(VTK QUIET HINTS ${VTK_DIR})
  # TODO: Clean this up and add minimum version support
