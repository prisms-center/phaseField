...
write_to_detailed("#
#    WARNING_FLAGS:         ${PRISMS_PF_WARNING_FLAGS}
#    CXX_FLAGS:             ${PRISMS_PF_CXX_FLAGS}
#    CXX_FLAGS_DEBUG:       ${PRISMS_PF_CXX_FLAGS_DEBUG}
#    CXX_FLAGS_RELEASE:     ${PRISMS_PF_CXX_FLAGS_RELEASE}
#    ADDITIONAL_CXX_FLAGS:  ${PRISMS_PF_ADDITIONAL_CXX_FLAGS}
#
#    LINKER_FLAGS:          ${PRISMS_PF_LINKER_FLAGS}
#    LINKER_FLAGS_DEBUG:    ${PRISMS_PF_LINKER_FLAGS_DEBUG}
