...
Section \ref{app_files} discusses the structure of the files that define an application: equations.h, ICs\_and\_BCs.h, postprocess.h, customPDE.h, and main.cc. Users who want to substantially modify existing PRISMS-PF applications or create their own will find this section useful.
...
\begin{center}
    \begin{tabular}{ | p{0.2\textwidth} | p{0.17\textwidth} | p{0.08\textwidth} | p{0.1\textwidth} | p{0.3\textwidth} |}
    \hline
      \multicolumn{5}{|c|}{\textbf{Mesh Adaptivity}} \\
    \hline
    \hline
    \emph{Name} & \emph{Options} & \emph{Required} & \emph{Default} & \emph{Description} \\ \hline
...
\begin{center}
    \begin{tabular}{ | p{0.2\textwidth} | p{0.17\textwidth} | p{0.08\textwidth} | p{0.1\textwidth} | p{0.3\textwidth} |}
    \hline
      \multicolumn{5}{|c|}{\textbf{Elliptic Solver Parameters}} \\
    \hline
    \hline
    \emph{Name} & \emph{Options} & \emph{Required} & \emph{Default} & \emph{Description} \\ \hline
...
\section{The Application Files: equations.h, ICs\_and\_BCs.h, postprocess.h, customPDE.h, and main.cc} \label{app_files}
