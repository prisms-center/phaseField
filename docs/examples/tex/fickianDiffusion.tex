...
\smallskip
\centerline{\Large{\bf Classical (Fickian) diffusion example}}
\bigskip

\noindent Domain: 1.0x1.0\\ Mesh: 128x128\\ \\

\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/Fick_T100}
    \caption{Composition field at step 100. Initial Condition is $c=0.0$.}
\end{figure}
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/Fick_T5000}
    \caption{Composition field at step 5000.}
\end{figure}
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/Fick_T10000}
