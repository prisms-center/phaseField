...
\smallskip
\centerline{\Large{\bf Allen-Cahn example}}
\bigskip
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/AC_T0}
    \caption{Order parameter field at step 0. Initial Condition is random perturbation about $c=0.5$.}
\end{figure}
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/AC_T5000}
    \caption{Order parameter field at step 5000.}
\end{figure}
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/AC_T20000}
    \caption{Order parameter field at step 20000}
\end{figure}
