...
\smallskip
\centerline{\Large{\bf Cahn-Hilliard example}}
\bigskip
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/CH_T0}
    \caption{Composition field at step 0. Initial Condition is random perturbation about $c=0.5$.}
\end{figure}
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/CH_T20000}
    \caption{Composition field at step 20000.}
\end{figure}
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/CH_T100000}
    \caption{Composition field at step 100,000}
\end{figure}
