...
\smallskip
\centerline{\Large{\bf Coupled Cahn-Hilliard and Mechanics example}}
\bigskip
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.75\textwidth]{../figures/CHMech_T0}
    \caption{Composition field at step 0. Initial Condition is random perturbation about $c=0.5$.}
\end{figure}
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.75\textwidth]{../figures/CHMech_T10000}
    \caption{Composition field and displacement vectors at step 10000.}
\end{figure}

\begin{figure}[h!]
  \centering
    \includegraphics[width=0.75\textwidth]{../figures/CHMech_T30000}
    \caption{Composition field and displacement vectors at step 30,000}
\end{figure}

\begin{figure}[h!]
  \centering
    \includegraphics[width=0.75\textwidth]{../figures/CHMech_T72000}
    \caption{Composition field and displacement vectors at step 72,000}
\end{figure}
