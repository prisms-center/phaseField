...
\smallskip
\centerline{\Large{\bf Coupled Cahn-Hilliard and Allen-Cahn example}}
\bigskip
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/CHAC_c_T0}
    \caption{Composition field at step 0.}
\end{figure}

\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/CHAC_n_T0}
    \caption{Order parameter field at step 0.}
\end{figure}

\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/CHAC_c_T10000}
    \caption{Composition field at step 10,000}
\end{figure}

\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{../figures/CHAC_n_T10000}
    \caption{Order parameter field at step 10,000}
\end{figure}
