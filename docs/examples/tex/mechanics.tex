...
\smallskip
\centerline{\Large{\bf Mechanics example}}
\bigskip

\noindent Domain: 100x100x100\\ Mesh: 16x16x16\\Boundary conditions: $u=0$ on $x=0$, $u_x=1.0$ on $x=100$\\ \\
MaterialModelV ISOTROPIC\\
MaterialConstantsV \{1.0,0.3\}

\begin{figure}[h!]
  \centering
    \includegraphics[width=0.8\textwidth]{../figures/Mech_T1}
    \caption{Deformed configuration with displacement vectors. Displacement scaled for visualization.}
\end{figure}
