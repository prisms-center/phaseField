...
scalargradType eqx_c_temp = ( cx + (c_alpha-c_beta)*(hn1V*n1x + hn2V*n2x + hn3V*n3x));
scalargradType eqx_c = (constV(-userInputs.dtValue)*McV*eqx_c_temp);

scalarvalueType eq_n1 = (n1-constV(userInputs.dtValue*Mn1V)*gamma*( (fbV-faV)*hn1V - (c_beta-c_alpha)*facV*hn1V + W*fbarriern1V + nDependentMisfitAC1));
scalargradType eqx_n1 = (constV(-userInputs.dtValue*Mn1V)*gamma*Knx1);

scalarvalueType eq_n2 = (n2-constV(userInputs.dtValue*Mn2V)*gamma*( (fbV-faV)*hn2V - (c_beta-c_alpha)*facV*hn2V + W*fbarriern2V + nDependentMisfitAC2));
scalargradType eqx_n2 = (constV(-userInputs.dtValue*Mn2V)*gamma*Knx2);

scalarvalueType eq_n3 = (n3-constV(userInputs.dtValue*Mn3V)*gamma*( (fbV-faV)*hn3V - (c_beta-c_alpha)*facV*hn3V + W*fbarriern3V + nDependentMisfitAC3));
