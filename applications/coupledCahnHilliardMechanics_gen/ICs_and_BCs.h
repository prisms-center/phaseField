...
public:
  ...
  void vector_value (const Point<dim> &p,Vector<double> &vector_IC) const
  {
	  ...
	  if (index==2){   // FOR THE DISPLACEMENT u
		  vector_IC(0) = 0.0;
		  vector_IC(1) = 0.0;
	  }
	  // =====================================================================
...
//	inputBCs(2,1,"PERIODIC",0.0,"PERIODIC",0.0,"DIRICHLET",0.0,"ZERO_DERIVATIVE",0.0);
	...
	inputBCs(0,0,"PERIODIC",0.0,"PERIODIC",0.0,"PERIODIC",0.0,"PERIODIC",0.0);
	inputBCs(1,0,"PERIODIC",0.0,"PERIODIC",0.0,"PERIODIC",0.0,"PERIODIC",0.0);

	inputBCs(2,0,"PERIODIC",0.0,"PERIODIC",0.0,"PERIODIC",0.0,"PERIODIC",0.0);
	inputBCs(2,1,"PERIODIC",0.0,"PERIODIC",0.0,"PERIODIC",0.0,"PERIODIC",0.0);

//	inputBCs(0,0,"ZERO_DERIVATIVE",0.0,"ZERO_DERIVATIVE",0.0,"ZERO_DERIVATIVE",0.0,"ZERO_DERIVATIVE",0.0);
//	inputBCs(1,0,"ZERO_DERIVATIVE",0.0,"ZERO_DERIVATIVE",0.0,"ZERO_DERIVATIVE",0.0,"ZERO_DERIVATIVE",0.0);
//
//	inputBCs(2,0,"ZERO_DERIVATIVE",0.0,"ZERO_DERIVATIVE",0.0,"ZERO_DERIVATIVE",0.0,"ZERO_DERIVATIVE",0.0);
//	inputBCs(2,1,"ZERO_DERIVATIVE",0.0,"ZERO_DERIVATIVE",0.0,"ZERO_DERIVATIVE",0.0,"ZERO_DERIVATIVE",0.0);
