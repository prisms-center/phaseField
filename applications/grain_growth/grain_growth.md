# PRISMS-PF Application Formulation: grain_growth
...
The above values of  $r_{\eta_i}$ and $r_{\eta_i x}$ are used to define the residuals in the custom PDE header file:
`applications/grain_growth/customPDE.h`
