...
#define spanX (160.0*scaleFactor)
#define spanY (160.0*scaleFactor)
...
#define subdivisionsX 2 //10
#define subdivisionsY 2 //10
#define subdivisionsZ 1 //5
#define refineFactor 6 //6
...
#define timeIncrements 10 //5000000
