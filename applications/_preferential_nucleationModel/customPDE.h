...
private:
	...
	double nucProb(double cValue, double dV, double dk1, double dk2) const;
    ...
    //Method to define AMR refinement criterion. This method overrides virtual method on MatrixFreePDE
