...
void variableAttributeLoader::loadVariableAttributes(){
    ...
    for (unsigned int var_index=0; var_index<6; var_index++){
        ...
        set_dependencies_value_residual_term_RHS(var_index, "n0, n1, n2, n3, n4, n5");
        set_dependencies_gradient_residual_term_RHS(var_index, "grad(n0), grad(n1), grad(n2), grad(n3), grad(n4), grad(n5)");
