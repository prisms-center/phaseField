...
scalargradType rcxTemp = ( cx + (c_alpha-c_beta)*(hn1V*n1x + hn2V*n2x + hn3V*n3x));
scalargradType rcxV = (constV(-userInputs.dtValue)*McV*rcxTemp);

scalarvalueType rn1V = (n1-constV(userInputs.dtValue*Mn1V)*gamma*( (fbV-faV)*hn1V - (c_beta-c_alpha)*facV*hn1V + W*fbarriern1V + nDependentMisfitAC1));
scalargradType rn1xV = (constV(-userInputs.dtValue*Mn1V)*gamma*Knx1);

scalarvalueType rn2V = (n2-constV(userInputs.dtValue*Mn2V)*gamma*( (fbV-faV)*hn2V - (c_beta-c_alpha)*facV*hn2V + W*fbarriern2V + nDependentMisfitAC2));
scalargradType rn2xV = (constV(-userInputs.dtValue*Mn2V)*gamma*Knx2);

scalarvalueType rn3V = (n3-constV(userInputs.dtValue*Mn3V)*gamma*( (fbV-faV)*hn3V - (c_beta-c_alpha)*facV*hn3V + W*fbarriern3V + nDependentMisfitAC3));
scalargradType rn3xV = (constV(-userInputs.dtValue*Mn3V)*gamma*Knx3);
