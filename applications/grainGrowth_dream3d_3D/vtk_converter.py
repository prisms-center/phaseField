...
rl_grid_filename = 'resampled.vtk' #'dream3d_test.vtk'
...
for z_counter in range(0, num_z_coords - 1):
    for y_counter in range(0, num_y_coords - 1):
        for x_counter in range(0, num_x_coords - 1):
            ...
            #print('Counter and base index: ',x_counter,y_counter,z_counter,base_index)
            #print('Index list: ',base_index,base_index + 1,base_index + (num_x_coords),base_index + (num_x_coords) + 1,base_index + num_x_coords*num_y_coords,base_index + num_x_coords*num_y_coords + 1,base_index + (num_x_coords+ num_x_coords*num_y_coords),base_index + (num_x_coords) + num_x_coords*num_y_coords + 1)
