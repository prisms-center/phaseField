...
void variableAttributeLoader::loadVariableAttributes(){
  ...
  set_variable_equation_type		(6, TIME_INDEPENDENT);
    ...
    set_dependencies_value_term_LHS     (6, "nAnodic, nCathodic, grad(psi), change(Phi), Phi, xiAnodic");
...
void customPDE<dim,degree>::explicitEquationRHS(variableContainer<dim,degree,dealii::VectorizedArray<double> > & variable_list,
    ...
    scalarvalueType v = constV(1.0 - switchVal) * vMin + 
                        constV(switchVal) * vMax;
...
void customPDE<dim,degree>::nonExplicitEquationRHS(variableContainer<dim,degree,dealii::VectorizedArray<double> > & variable_list,
 ...
 // --- Getting the values and derivatives of the model variables ---
    ...
    scalarvalueType rmuAnodic = (nAnodic*nAnodic*nAnodic - 
                                nAnodic + constV(2.0)*gamma*nAnodic*psi*psi + 
    ...
    scalarvalueType rmuCathodic = (nCathodic*nCathodic*nCathodic - 
                                  nCathodic + constV(2.0)*gamma*nCathodic
                                  *psi*psi + constV(2.0)*gamma*nCathodic
                                  *nAnodic*nAnodic);
    ...
    scalarvalueType rmupsi = (psi*psi*psi - psi + 
                             constV(2.0)*gamma*psi*nAnodic*nAnodic + 
    ...
    scalarvalueType xiCathodic = nCathodic/
                                 max(nAnodic + nCathodic, constV(lthresh));
...
void customPDE<dim,degree>::equationLHS(variableContainer<dim,degree,dealii::VectorizedArray<double> > & variable_list,
    ...
    scalarvalueType irxnp = - xiAnodic*(iMax/(iMax + itafel))
                            *(iMax/(iMax + itafel))*(itafel/AAnodic) 
