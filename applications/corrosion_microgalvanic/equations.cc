    ...
    dealii::Point<dim, dealii::VectorizedArray<double>> q_point_loc) const
{
    ...
    scalarvalueType rmuAnodic = (nAnodic * nAnodic * nAnodic - nAnodic + constV(2.0) * gamma * nAnodic * psi * psi + constV(2.0) * gamma * nAnodic * nCathodic * nCathodic);
    ...
    scalarvalueType rmuCathodic = (nCathodic * nCathodic * nCathodic - nCathodic + constV(2.0) * gamma * nCathodic * psi * psi + constV(2.0) * gamma * nCathodic * nAnodic * nAnodic);
    ...
    scalarvalueType rmupsi = (psi * psi * psi - psi + constV(2.0) * gamma * psi * nAnodic * nAnodic + constV(2.0) * gamma * psi * nCathodic * nCathodic);
