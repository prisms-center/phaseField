...
private:
  ...
  friendly_format_name(const std::string &raw_pattern)
  {
    if (raw_pattern.starts_with("[Integer"))
      {
        return "Integer";
      }
    if (raw_pattern.starts_with("[Double"))
      {
        return "Double";
      }
    if (raw_pattern.starts_with("[Bool"))
      {
        return "Boolean";
      }
    if (raw_pattern.starts_with("[Selection"))
      {
