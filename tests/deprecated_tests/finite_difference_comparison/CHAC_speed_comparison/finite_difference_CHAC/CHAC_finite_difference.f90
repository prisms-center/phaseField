...
REAL(KIND=8), DIMENSION(S1:S1+L1-1,S2:S2+L2-1,S3:S3+L3-1) :: c, eta, x, y, z
...
DO i = Is1-1,Ie1+1
	...
	c(i,j,k) = 0.5d0*(0.12d0-avg_Nd) * (1.0d0 - ( TANH( ( dist_particle - rad )/delta ))) + avg_Nd
...
call commuBC(Id1,Id2,Id3,L1,L2,L3,S1,S2,S3,c,left,right,front,back,top,bot,cartcomm)  	  
CALL external_BCs_Zero_Derivative(c,.TRUE.,1,Id1,Id2,Id3,L1-2,L2-2,L3-2)
CALL external_BCs_Zero_Derivative(c,.FALSE.,1,Id1,Id2,Id3,L1-2,L2-2,L3-2)
CALL external_BCs_Zero_Derivative(c,.TRUE.,2,Id1,Id2,Id3,L1-2,L2-2,L3-2)
CALL external_BCs_Zero_Derivative(c,.FALSE.,2,Id1,Id2,Id3,L1-2,L2-2,L3-2)
CALL external_BCs_Zero_Derivative(c,.TRUE.,3,Id1,Id2,Id3,L1-2,L2-2,L3-2)
CALL external_BCs_Zero_Derivative(c,.FALSE.,3,Id1,Id2,Id3,L1-2,L2-2,L3-2)
...
CALL writeLotsFiles(c,'con_r',out_num,Is1,Ie1,Is2,Ie2,Is3,Ie3, Id1,Id2,Id3)
...
DO iter = 1,max_iter
	...
	CALL simultaneous_CHAC_solver(c,eta,S1,S2,S3,L1,L2,L3,Is1,Ie1,Is2,Ie2,Is3,Ie3,Id1,Id2,Id3, &
										left,right,front,back,top,bot,cartcomm)
										
	
	!CALL cahnhilliard_solver_explicit(c,eta,S1,S2,S3,L1,L2,L3,Is1,Ie1,Is2,Ie2,Is3,Ie3,Id1,Id2,Id3, &
!										left,right,front,back,top,bot,cartcomm)
				  
	!! Check to see if c contains a NAN
	IF (ANY(ISNAN(c))) THEN
		PRINT *, 'Error: Element in c is NAN'
		STOP
	END IF
	
	!CALL allenCahn_solver_explicit(c,eta,S1,S2,S3,L1,L2,L3,Is1,Ie1,Is2,Ie2,Is3,Ie3,Id1,Id2,Id3, &
!										left,right,front,back,top,bot,cartcomm)
	...
	!! -------------------------------------------------------------------------
	!! Output files
	IF (max_iter <= num_outputs) THEN
		output_crit = 0
	ELSE  
		output_crit = MOD(iter,max_iter/num_outputs)
	END IF 
...
!! ===================================================================================
!! Explicit Combined Cahn-Hilliard Allen-Cahn Solver
!! ===================================================================================

SUBROUTINE simultaneous_CHAC_solver(c,eta,S1,S2,S3,L1,L2,L3,Is1,Ie1,Is2,Ie2,Is3,Ie3,Id1,Id2,Id3, &
										left,right,front,back,top,bot,cartcomm)
USE parameters
IMPLICIT NONE
...
mu = (2.0d0*A_alpha*c + B_alpha)*(1.0d0-H) + (2.0d0*A_beta*c + B_beta)*H

call commuBC(Id1,Id2,Id3,L1,L2,L3,S1,S2,S3,mu,left,right,front,back,top,bot,cartcomm)  	  
CALL external_BCs_Zero_Derivative(mu,.TRUE.,1,Id1,Id2,Id3,L1-2,L2-2,L3-2)
CALL external_BCs_Zero_Derivative(mu,.FALSE.,1,Id1,Id2,Id3,L1-2,L2-2,L3-2)
CALL external_BCs_Zero_Derivative(mu,.TRUE.,2,Id1,Id2,Id3,L1-2,L2-2,L3-2)
CALL external_BCs_Zero_Derivative(mu,.FALSE.,2,Id1,Id2,Id3,L1-2,L2-2,L3-2)
CALL external_BCs_Zero_Derivative(mu,.TRUE.,3,Id1,Id2,Id3,L1-2,L2-2,L3-2)
CALL external_BCs_Zero_Derivative(mu,.FALSE.,3,Id1,Id2,Id3,L1-2,L2-2,L3-2)

Lap_mu(Is1:Ie1,Is2:Ie2,Is3:Ie3) = (mu(Is1+1:Ie1+1,Is2:Ie2,Is3:Ie3) - 2.0d0*mu(Is1:Ie1,Is2:Ie2,Is3:Ie3) &
			+ mu(Is1-1:Ie1-1,Is2:Ie2,Is3:Ie3))/dx**2 &
			+ (mu(Is1:Ie1,Is2+1:Ie2+1,Is3:Ie3) - 2.0d0*mu(Is1:Ie1,Is2:Ie2,Is3:Ie3) &
			+ mu(Is1:Ie1,Is2-1:Ie2-1,Is3:Ie3))/dy**2 &
			+ (mu(Is1:Ie1,Is2:Ie2,Is3+1:Ie3+1) - 2.0d0*mu(Is1:Ie1,Is2:Ie2,Is3:Ie3) &
			+ mu(Is1:Ie1,Is2:Ie2,Is3-1:Ie3-1))/dz**2
...
kappa_Lap_eta(Is1:Ie1,Is2:Ie2,Is3:Ie3) = kappa_x*(eta(Is1+1:Ie1+1,Is2:Ie2,Is3:Ie3) - 2.0d0*eta(Is1:Ie1,Is2:Ie2,Is3:Ie3) &
			...
			+ kappa_z*(eta(Is1:Ie1,Is2:Ie2,Is3+1:Ie3+1) - 2.0d0*eta(Is1:Ie1,Is2:Ie2,Is3:Ie3) &
...
END SUBROUTINE simultaneous_CHAC_solver

!! ===================================================================================
!! Explicit Cahn-Hilliard Solver
!! ===================================================================================

SUBROUTINE cahnhilliard_solver_explicit(c,eta,S1,S2,S3,L1,L2,L3,Is1,Ie1,Is2,Ie2,Is3,Ie3,Id1,Id2,Id3, &
										left,right,front,back,top,bot,cartcomm)
USE parameters
IMPLICIT NONE
...
INTEGER :: L1, L2, L3, S1, S2, S3, Id1, Id2, Id3, Is1, Is2, Is3, Ie1, Ie2, Ie3
INTEGER :: left,right,front,back,top,bot, cartcomm 	
REAL(KIND=8), DIMENSION(S1:S1+L1-1,S2:S2+L2-1,S3:S3+L3-1) :: c, eta, mu, H
REAL(KIND=8), DIMENSION(S1+1:S1+L1-2,S2+1:S2+L2-2,S3+1:S3+L3-2) :: Lap_mu
...
END SUBROUTINE cahnhilliard_solver_explicit

!! ===================================================================================
!! Explicit Allen-Cahn Solver
!! ===================================================================================

SUBROUTINE allenCahn_solver_explicit(c,eta,S1,S2,S3,L1,L2,L3,Is1,Ie1,Is2,Ie2,Is3,Ie3,Id1,Id2,Id3, &
										left,right,front,back,top,bot,cartcomm)
USE parameters
IMPLICIT NONE
